    ...
    public ModelCliente getClienteDAO(int pIdCliente) {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelCliente.setCliNome(this.getResultSet().getNString(2));
                modelCliente.setCliEndereco(this.getResultSet().getNString(3));
                modelCliente.setCliBairro(this.getResultSet().getNString(4));
                modelCliente.setCliCidade(this.getResultSet().getNString(5));
                modelCliente.setCliUf(this.getResultSet().getNString(6));
                modelCliente.setCliCep(this.getResultSet().getNString(7));
                modelCliente.setCliTelefone(this.getResultSet().getNString(8));
